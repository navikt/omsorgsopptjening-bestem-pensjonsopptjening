...
internal class OmsorgsArbeidsUtbetalingerKtTest {
    ...
    fun `Given fom first day of month When calling getAntallUtbetalingMoneder Then return months of omsorgsarbeid omsorgsAr`(
        ...
        val perioder = listOf(
            OmsorgsvedtakPeriode(fom = fom, tom = tom, prosent = 100, omsorgsytere = listOf(person), omsorgsmottakere = listOf(), landstilknytning = Landstilknytning.NASJONAL)
        )
    ...
    fun `Given given two omsorgsArbeidsUtbetalinger Then count months overlapping with omsorgsAr`(
        ...
        val perioder = listOf(
            OmsorgsvedtakPeriode(fom = fom1, tom = tom1, prosent = 100, omsorgsytere = listOf(person), omsorgsmottakere = listOf(), landstilknytning = Landstilknytning.NASJONAL),
            OmsorgsvedtakPeriode(fom = fom2, tom = tom2, prosent = 100, omsorgsytere = listOf(person), omsorgsmottakere = listOf(), landstilknytning = Landstilknytning.NASJONAL)
        )
    ...
    fun `Given given three utbetalings periodes Then count months overlapping with omsorgsAr`(
        ...
        val perioder = listOf(
            OmsorgsvedtakPeriode(fom = fom1, tom = tom1, prosent = 100, omsorgsytere = listOf(person), omsorgsmottakere = listOf(), landstilknytning = Landstilknytning.NASJONAL),
            OmsorgsvedtakPeriode(fom = fom2, tom = tom2, prosent = 100, omsorgsytere = listOf(person), omsorgsmottakere = listOf(), landstilknytning = Landstilknytning.NASJONAL),
            OmsorgsvedtakPeriode(fom = fom3, tom = tom3, prosent = 100, omsorgsytere = listOf(person), omsorgsmottakere = listOf(), landstilknytning = Landstilknytning.NASJONAL)
        )
    ...
    fun `Given zero omsorgsArbeidsUtbetalinger When calling getAntallUtbetalingMoneder Then 0`() {
        assertEquals(0, listOf<OmsorgsvedtakPeriode>().getAntallUtbetalingMoneder(2020))
    }
