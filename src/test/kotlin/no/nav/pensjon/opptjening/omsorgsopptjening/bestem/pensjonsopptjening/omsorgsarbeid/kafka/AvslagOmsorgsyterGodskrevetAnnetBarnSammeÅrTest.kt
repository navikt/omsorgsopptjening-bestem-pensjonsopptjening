                ...
                assertInstanceOf(AutomatiskGodskrivingUtfall.Avslag::class.java, it.utfall).also {
                    assertEquals(
                        listOf(
                            ...
                            ParagrafOppsummering(Lovhenvisning.IKKE_KRAV_OM_MINST_HALVT_AR_I_FODSELSAR to true),
                            ...
                            ParagrafOppsummering(Lovhenvisning.KAN_KUN_GODSKRIVES_ET_BARN to false),
                        ),
