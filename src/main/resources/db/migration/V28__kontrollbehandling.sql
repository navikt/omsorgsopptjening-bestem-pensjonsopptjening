...
create index kontrollmelding_kafkameldingid on kontrollmelding(kafkameldingid);
...
create index kontrollbehandling_kafkameldingid on kontrollbehandling(kafkameldingid);
