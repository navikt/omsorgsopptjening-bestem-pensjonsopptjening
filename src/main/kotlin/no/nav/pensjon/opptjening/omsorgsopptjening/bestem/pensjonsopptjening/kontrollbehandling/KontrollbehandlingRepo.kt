...
class KontrollbehandlingRepo(
    ...
    fun oppdaterMedBrev(fullførtBehandling: FullførtBehandling, brevopplysninger: Brevopplysninger.InfobrevOmsorgsyterForHjelpestønadsmottaker) {
        jdbcTemplate.update(
    ...
    fun oppdaterMedOppgave(fullførtBehandling: FullførtBehandling, oppgaveopplysninger: List<Oppgaveopplysninger>){
        jdbcTemplate.update(
            ...
            MapSqlParameterSource(
                mapOf(
                    "id" to fullførtBehandling.id,
                    "oppgave" to oppgaveopplysninger.serializeList()
                )
            )
        )
    }
